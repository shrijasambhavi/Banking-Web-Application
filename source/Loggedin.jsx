      ...
      <div class="logo-image">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            <Nav.Link as ={Link} to = {`/Accountdetails/${customer_id}`}>Account Details</Nav.Link>
            {/* <Nav.Link onClick={(e)=>onSubmit(e)}>Account Details</Nav.Link> */}
          ...
          <div className="display-name ms-auto ms-2">
              <i className="fa fa-circle text-success me-2"></i>
              Welcome, {`${customer_id}`}! <span></span>
          </div>
        </Navbar.Collapse>
      </Navbar>
